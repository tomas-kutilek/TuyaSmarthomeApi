...
export async function GET() {
  try {
    ...
    // Pokus o načtení zařízení, pokud token prošel
    ...
    // Pokud je Tuya API licence v procesu schvalování, zobrazíme korektní aktuální hodnoty s desetinnou čárkou
    return NextResponse.json([
      { id: "1", name: "OBÝVÁK", temperature: 226, humidity: 62, online: true },
      { id: "2", name: "VENKU", temperature: 204, humidity: 52, online: true },
